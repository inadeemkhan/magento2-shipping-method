# Magento2 Hyper Shipping Method
...
1. If cart Price is more then $100 then  shipping will free.
2. Looks like core functionality of Magento (at backend as well as frontend)
3. Unencrypted code for easy customization

# Installation Instruction

* Copy the content of the repo to the <b>app/code/Magelumen/HyperShipping/</b> folder
* Run command:
